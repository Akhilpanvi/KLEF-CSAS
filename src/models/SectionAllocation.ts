...
/**
 * A single department×section cell. Before finalization these rows are manual
...
SectionAllocationSchema.index({ allocationGroup: 1, department: 1, sectionNumber: 1 }, { unique: true });
